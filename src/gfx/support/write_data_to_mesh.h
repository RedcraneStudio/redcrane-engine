...
namespace redc { namespace gfx
{
  ...
  void allocate_mesh_buffers(Indexed_Mesh_Data const& data, IMesh& mesh,
                             Upload_Hint up = Upload_Hint::Static,
                             Usage_Hint us = Usage_Hint::Draw) noexcept;
  void allocate_mesh_buffers(Ordered_Mesh_Data const& data, IMesh& mesh,
                             Upload_Hint up = Upload_Hint::Static,
                             Usage_Hint us = Usage_Hint::Draw) noexcept;

  void format_mesh_buffers(IMesh&) noexcept;
